...
# Bot information
API_ID = environ.get('API_ID', '23171051')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '10331d5d712364f57ffdd23417f4513c') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7048321332:AAHPENYXo2TS0A6OyncBEeppsOCf8Ap87GM') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6987799874') #apni tg id daalo
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002092211536') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002023455423') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Rishikesh:Rishikesh@cluster0.oejlyy1.mongodb.net/?retryWrites=true&w=majority") #mongo db url
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "Rishikesh")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002047761206") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://rishikeshfilerbot-8078cfe993c7.herokuapp.com/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
